...
const BOOK_URL = "/media/life-happens-in-decisions.pdf";
const TOTAL_PAGES = 184;
const LOCAL_STATS_KEY = "lhid-reader-stats";
...
async function trackEvent(name, params = {}) {
  ...
  if (a) {
    try {
      logEvent(a, name, { book: "life_happens_in_decisions", ...params });
    } catch (_) {}
  }
