...
import { ensureAnalytics, trackEvent } from "./firebase-client.js";

pdfjsLib.GlobalWorkerOptions.workerSrc =
  "https://cdnjs.cloudflare.com/ajax/libs/pdf.js/4.4.168/pdf.worker.min.mjs";

const STORAGE_KEY = "lhim-last-page";
...
function fillWatermark() {
  wm.innerHTML = "";
  const stamp = `${viewerId} · Life Happens in Moments · ${new Date().toISOString().slice(0, 16)}Z`;
  for (let i = 0; i < 18; i++) {
